...
export default {
  ...
  settingsHub: {
    ...
    autoOverdue: 'Uplata kojoj je prošao rok diže upozorenje dok se ne naplati.',
    autoContract: 'Ugovor pred istek pojavljuje se 45 dana unapred.',
    autoCommission: 'Upisana uplata pravi proviziju partneru, u statusu „na čekanju“.',
    autoGoals: 'Napredak cilja se prebrojava iz živih zapisa svaki put kad se prikaže.',
