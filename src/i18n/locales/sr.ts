...
export default {
  ...
  credit: {
    title: 'Isplati nekome za ovu rezervaciju',
    who: 'Ko ju je doneo',
    pickPerson: 'Izaberi osobu…',
    whoHint: 'Sebi ne možeš da upišeš — baza to odbija.',
    amount: 'Njegov deo',
    amountHint: 'Ti odlučuješ. {suggested} je trećina onoga što smo zaradili, samo kao polazna tačka.',
    reason: 'Za šta je',
    weEarned: 'zaradili smo {amount}',
    give: 'Isplati deo',
    done: 'Dodato u zaradu — {name}.',
    needPerson: 'Izaberi ko ju je doneo.',
  ...
  staybrain: {
    ...
    paidAmount: 'Primljeni iznos',
    paidAmountHint: 'Deo ili sve. Zabeleži svaku uplatu kako stigne.',
    needPayAmount: 'Upiši koliko je stiglo.',
    paymentRecorded: 'Uplata zabeležena.',
    allSettled: 'nema duga',
    ...
    joinFeeNote: 'Napomena',
    joinFeeNotePlaceholder: 'Plaćeno u martu, dve rate…',
    joinFeeShort: 'Ulaz',
    commissionShort: 'Provizija',
    commissionElsewhere: 'Provizija se ne postavlja ovde. Upisuje se na svaku rezervaciju u RMS-u — procenat ili po noći — jer se tamo i dogovara.',
    feesTotal: 'Ulazne naknade',
    feesTotalHint: 'Plaćeno za samu uslugu.',
    commissionTotal: 'Provizija',
    commissionTotalHint: 'Od rezervacija koje smo doneli.',
    earnedTotal: 'Ukupno zarađeno',
    earnedTotalHint: 'Naknade plus provizija. Promet klijenta nije naš i nije u ovome.',
    openToSee: 'Otvori da vidiš sve rezervacije.',
    rmsEmailPlaceholder: 'Login ovog smeštaja u RMS-u',
    linkAccount: 'Poveži ovaj smeštaj',
    linkHint: 'Prijava potvrđuje nalog i beleži na koje podatke ovaj smeštaj pokazuje. Lozinka se pamti samo u ovom browseru, nikad u bazi firme.',
    passwordRemembered: 'lozinka zapamćena ovde',
    passwordNeeded: 'lozinka će biti zatražena jednom',
    changeAccount: 'Koristi drugi nalog',
  ...
  rms: {
    signInToRead: 'Prijavi se da pročitaš ovaj smeštaj — njegov nalog, ili tvoja admin prijava za platformu.',
    cannotSeeProperty: 'Ova prijava ne može da čita taj smeštaj. Koristi nalog tog smeštaja, ili admin prijavu.',
    propertyLive: 'Povezano sa ovim smeštajem',
    propertyLiveHint: 'Čita se {email}. Kalendar i rezervacije su živi.',
    propertyLocked: 'Nije povezano sa ovim smeštajem',
    propertyLockedHint: 'Unesi lozinku za {email} jednom — ovaj browser je pamti.',
    propertyRefused: 'Prijava je odbijena: {code}',
    noAccountOnListing: 'Ovaj smeštaj još nema nalog u rezervacionom sistemu. Dodaj ga preko Uslova.',
    enterPassword: 'Unesi lozinku',
    rememberedHere: 'Pamti se samo u ovom browseru, nikad u bazi firme — lozinka klijenta je njegova. Na drugom računaru se unosi još jednom.',
    forget: 'Zaboravi lozinku',
    forgetHint: 'Skloni sačuvanu lozinku iz ovog browsera',
