...
export default {
  ...
  settingsHub: {
    ...
    autoOverdue: 'A payment past its due date raises an alert until it is collected.',
    autoContract: 'A contract nearing its end appears 45 days ahead.',
    autoCommission: 'A recorded payment creates the affiliate commission, as pending.',
    autoGoals: 'Goal progress is recounted from live records every time it is shown.',
