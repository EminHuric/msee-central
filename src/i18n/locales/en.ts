...
export default {
  ...
  credit: {
    title: 'Pay somebody for this booking',
    who: 'Who brought it',
    pickPerson: 'Choose a person…',
    whoHint: 'You cannot credit yourself — the database refuses it.',
    amount: 'Their share',
    amountHint: 'Yours to decide. {suggested} is a third of what we earned, offered only as a starting point.',
    reason: 'What it is for',
    weEarned: 'we earned {amount}',
    give: 'Pay a share',
    done: 'Added to {name}’s earnings.',
    needPerson: 'Choose who brought it.',
  ...
  staybrain: {
    ...
    paidAmountHint: 'Part or all. Record each payment as it arrives.',
    needPayAmount: 'Enter how much arrived.',
    paymentRecorded: 'Payment recorded.',
    allSettled: 'nothing outstanding',
    ...
    joinFeeAmount: 'Amount paid',
    joinFeeHint: 'Per client, because it is agreed per client. One pays more, another less.',
    joinFeeNote: 'Note',
    joinFeeNotePlaceholder: 'Paid in March, two instalments…',
    joinFeeShort: 'Joining fee',
    commissionShort: 'Commission',
    commissionElsewhere: 'The commission is not set here. It is typed on each booking in the RMS — by percentage or per night — because that is where it is agreed.',
    feesTotal: 'Joining fees',
    feesTotalHint: 'Paid for the service itself.',
    commissionTotal: 'Commission',
    commissionTotalHint: 'From the bookings we brought.',
    earnedTotal: 'Total earned',
    earnedTotalHint: 'Fees plus commission. The client’s own turnover is not ours and is not in here.',
    openToSee: 'Open it to see every reservation.',
    rmsEmailPlaceholder: 'The login for this property in the RMS',
    linkAccount: 'Link this property',
    linkHint: 'Signing in confirms the account and records which data this property points at. The password is remembered in this browser only, never in the company database.',
    passwordRemembered: 'password remembered here',
    passwordNeeded: 'password will be asked once',
    ...
    rmsAccountHint: 'Only accounts that have allowed agency bookings appear here.',
    noAccountsYet: 'No RMS account has allowed agency bookings yet. In the RMS, open Admin, find the account, and press "Allow agency bookings".',
    unitCount: '{n} unit(s)',
  ...
  rms: {
    signInToRead: 'Sign in to read this property — its own account, or your administrator login for the platform.',
    cannotSeeProperty: 'This login cannot read that property. Use the property’s own account, or an administrator login.',
    propertyLive: 'Connected to this property',
    propertyLiveHint: 'Reading {email}. The calendar and bookings are live.',
    propertyLocked: 'Not connected to this property',
    propertyLockedHint: 'Enter the password for {email} once — this browser remembers it.',
    propertyRefused: 'That login was refused: {code}',
    noAccountOnListing: 'This property has no reservation-system account yet. Add it under Terms.',
    enterPassword: 'Enter password',
    rememberedHere: 'Remembered in this browser only, never in the company database — a client’s password is theirs. On another computer it is entered once more.',
    forget: 'Forget password',
    forgetHint: 'Remove the saved password from this browser',
